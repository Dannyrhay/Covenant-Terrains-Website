...
const HeroControls = ({ slideCount, currentSlide, onPrev, onNext, onSelect }) => (
  <>
    <button
      onClick={onPrev}
...
const useHeroCarousel = (slides, autoPlayInterval) => {
...
const Hero = ({ slides = [], title, subtitle, autoPlayInterval = 8000 }) => {
  const { currentSlide, setCurrentSlide, nextSlide, prevSlide } = useHeroCarousel(slides, autoPlayInterval);
